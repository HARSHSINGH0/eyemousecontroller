...
class Ui_MainWindow:
    def setupUi(self, MainWindow):
        ...
        self.cameralabel_3.setGeometry(QtCore.QRect(300, 780, 421, 61))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cameralabel_3.setText(_translate("MainWindow", "NOTE: Only one person in frame is needed for program to work fine /n If no result then camera number is wrong"))
        self.cameralabel_3.adjustSize()
